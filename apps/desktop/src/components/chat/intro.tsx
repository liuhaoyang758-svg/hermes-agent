  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-sans font-semibold uppercase leading-[0.9] tracking-[0.06em] text-midground/70"
          style={{ '--fit-min': '2rem', '--fit-max': '3rem' } as CSSProperties}
        >
          <span>
            <span>{WORDMARK}</span>
          </span>
